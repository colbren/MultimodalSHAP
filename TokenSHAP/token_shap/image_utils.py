...
try:
    import sys, os
    # Correct: define path to the local sam2 repo
    DYNAMIC_SAM2_PATH = os.path.abspath("../DynamicSAM2")  # adjust path as needed
    os.environ["DYNAMIC_SAM2_PATH"] = DYNAMIC_SAM2_PATH
    sys.path.append(DYNAMIC_SAM2_PATH)
    ...
    def _initialize_sam2(self):
        ...
        try:
            ...
            sam2_model = build_sam2(
                config_file=self.sam2_cfg_path,
                ckpt_path=self.sam2_ckpt_path,
                device=self.device  # 🔥 This is the key change
            )
